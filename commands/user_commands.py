...
class Help(Command):
    ...
    def run(self, bot: "VkBot", event: "VkBotEvent"):
        ...
        forwards_help += " - Рыбалка - подсчитает количество лута за обыск руин (первое сообщение должно быть с началом поиска, последнее - нет добычи или прекращение поиска)\n"
