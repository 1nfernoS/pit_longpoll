book_pages = {
    ...
    'заставить противника призвать их для помощи в': 'Угроза',
    'сама по себе, однако тайные знания, содержащиеся в': 'Знания древних'
}
...
door_answers = {
    ...
    'ВСЕ ИСПОЛЬЗУЮТ ЗЕЛЬЕ ПАМЯТИ': 'Цены последнего купленного зелья памяти \n10k - 3, 100k - 4, 1kk - 5 и т.д.'
}
